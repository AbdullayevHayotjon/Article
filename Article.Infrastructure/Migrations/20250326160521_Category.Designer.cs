...
namespace Article.Infrastructure.Migrations
{
    ...
    [Migration("20250326160521_Category")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Article.Domain.HelpModels.CategoryModel.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Categories", "MainSchema");
                });
            ...
            modelBuilder.Entity("Article.Domain.HelpModels.PasswordResetModel.PasswordReset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("PasswordResets", "HelpSchema");
                });

            modelBuilder.Entity("Article.Domain.HelpModels.RefreshTokenModel.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("RefreshTokens", "HelpSchema");
                });

            modelBuilder.Entity("Article.Domain.HelpModels.ReviewModel.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ArticleId")
                        .HasDatabaseName("ix_reviews_article_id");
            ...
            modelBuilder.Entity("Article.Domain.HelpModels.Specialization_Model.Specialization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_specializations_user_id");
            ...
            modelBuilder.Entity("Article.Domain.HelpModels.ReviewModel.Review", b =>
                {
                    b.HasOne("Article.Domain.MainModels.ArticleModels.ArticleModel", "Article")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reviews_articles_article_id");

                    b.HasOne("Article.Domain.MainModels.UserModel.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("Article.Domain.HelpModels.Specialization_Model.Specialization", b =>
                {
                    b.HasOne("Article.Domain.MainModels.UserModel.User", "user")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_specializations_users_user_id");
